    ...
    def train_dataloader(self):
        self.train_transforms = Compose(
            [
                ...
                # RandZoomDict(keys=["image3d"], prob=1.0, min_zoom=0.95, max_zoom=1.0, padding_mode='constant', mode=["trilinear"], align_corners=True),
                # RandZoomDict(keys=["image2d"], prob=1.0, min_zoom=0.95, max_zoom=1.0, padding_mode='constant', mode=["area"]),
                # RandFlipdict(keys=["image3d"], prob=0.5, spatial_ax5is=0),
